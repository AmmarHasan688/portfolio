...
_1626: () => globalThis.removeSplashFromWeb(),
...
_1773: a => a.join(''),
_1776: (s, t) => s.split(t),
_1777: s => s.toLowerCase(),
_1778: s => s.toUpperCase(),
_1779: s => s.trim(),
_1780: s => s.trimLeft(),
_1781: s => s.trimRight(),
_1783: (s, p, i) => s.indexOf(p, i),
...
_1833: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1834: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1836: (s, m) => {
          try {
...
_1881: l => arrayFromDartList(Uint8Array, l),
...
_1891: stringFromDartString,
_1892: stringToDartString,
_1893: () => ({}),
_1894: () => [],
_1895: l => new Array(l),
_1896: () => globalThis,
