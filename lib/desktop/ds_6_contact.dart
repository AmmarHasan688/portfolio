        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                SelectableText(DataValues.emailTitle,
                    style: TextStyle(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                SelectableText(DataValues.phoneTitle,
                    style: TextStyle(
                      fontSize: AppThemeData
                          .darkTheme.textTheme.titleMedium!.fontSize,
                      fontWeight: AppThemeData
                ...
                MouseRegion(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Clipboard.setData(
                        const ClipboardData(text: DataValues.phoneNumber),
                      );
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text(
                    ...
                    child: Tooltip(
                      message: 'Click to copy phone number to clipboard',
                      child: Text(
